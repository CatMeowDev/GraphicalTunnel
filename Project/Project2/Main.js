  ...
  //code for cube that I replces with defrming sphere
   ...
   // MovingCube.position.set(points[0].x+5, points[0].y+5, points[0].z + 10);
    ...
    //DEFORMED SPHERE TEXTURE CODE
    	...
    	var lavaTexture = new THREE.ImageUtils.loadTexture( 'http://i252.photobucket.com/albums/hh35/optics2/rainbow2-1.png');
	...
	var blendTexture = new THREE.ImageUtils.loadTexture( 'http://i252.photobucket.com/albums/hh35/optics2/rainbow2-1.png' );
